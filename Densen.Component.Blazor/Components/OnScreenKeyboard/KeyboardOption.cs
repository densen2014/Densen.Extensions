...
namespace AmeBlazor.Components
{
    ...
    public class KeyboardOption
    {
        ...
        /// <summary>
        ///  必需:必须为自定义键定义一个对象数组。提示：每个对象在键盘上创建一个行元素 (HTML)。
        ///  例如 [{"key":"value"}, {"key":"value"}] => [{"0":"A","1":"B","2":"C" }, {"0":"D","1":"E","2":"F"}] <para></para>
        /// </summary>
        public string? keysArrayOfObjects { get; set; } = null;
        ...
        /// </summary>
        public string keysJsonUrl { get => $"./_content/Densen.Component.Blazor/lib/kioskboard/kioskboard-keys-{KeyboardKeysType}.json"; }

        /// <summary> 
        ///  可选：可以设置一个字符串数组来覆盖内置的特殊字符。<para></para>
        ///  例如 ["#", "€", "%", "+", "-", "*"] 
        /// </summary>
        public string? keysSpecialCharsArrayOfStrings { get; set; } = "['#', '€', '%', '+', '-', '*']";
