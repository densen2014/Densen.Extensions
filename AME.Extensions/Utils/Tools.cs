...
*/
        ...
        public static string POSTjson(string poststr = "", string requeststr = "", string MethodName = "POST")
        {
            if (requeststr.Length == 0)
                requeststr = "http://127.0.0.1/app/dpos/add.php";
            // Create a request using a URL that can receive a post. 
            WebRequest request = WebRequest.Create(requeststr);
            // Set the Method property of the request to POST.
            request.Method = MethodName;
            // Create POST data and convert it to a byte array.
            string postData = "{\"PID\": \"xxx\",\"OID\": \"1255\",\"ORDER\":  [{\"UserCode\":\"0244120\",\"Quantity\":\"16\",\"ProductName\":\"玫瑰露\"},{\"UserCode\":\"12315444\",\"Quantity\":\"32\",\"ProductName\":\"香肠\"}]}";
            if (poststr.Length > 0)
                postData = poststr;
