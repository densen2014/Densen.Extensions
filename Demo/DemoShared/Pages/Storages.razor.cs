...
public class Users
{
    ...
    [AutoGenerateColumn(Visible = false, IsReadonlyWhenEdit = true)]
    ...
    [AutoGenerateColumn(Visible = false, IsReadonlyWhenEdit = true, ComponentType = typeof(BootstrapPassword))]
    [DisplayName("用户密码")]
    [Required]
